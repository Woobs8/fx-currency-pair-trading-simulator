...
def add_simulation_arguments(parser):
    ...
    parser.add_argument('--delta', type=float, help='magnitude short average must differ from long average to be considred a break', required=True)
    ...
    offset_strat_parser.add_argument('--stop_profit', '--profit', type=float, help='delta for setting stop profit', required=True)
